...
import { loadPreset, listPresets, deletePreset, getBuiltinPreset, BUILTIN_PRESETS } from './core/presets.js';
    ...
    program
        ...
        try {
            ...
            if (options.preset) {
                ...
                console.log();
                const infoBox = boxen(chalk.cyan.bold('🎯 Using Preset\n\n') +
            ...
            // Check if using custom template URL
                ...
                console.log();
                const infoBox = boxen(chalk.cyan.bold('🔗 Using Custom Template\n\n') +
            ...
            // Check if using direct template
                ...
                projectConfig = {
                    ...
                    apps: {
                        frontend: {
                            framework: (parts[1] === 'nextjs' ? 'next.js' : parts[1]),
                            // TypeScript is always enabled
                            styling: 'tailwind',
                            linting: true
                        },
                        backend: {
                            framework: (parts[2] === 'nestjs' ? 'nest.js' : parts[2]),
                            database: parts[3],
                            orm: parts[4],
                            docker: true
                        }
                ...
                console.log();
                const infoBox = boxen(chalk.cyan.bold('🚀 Using Template\n\n') +
